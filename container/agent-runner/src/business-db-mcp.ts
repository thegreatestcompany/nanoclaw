...
Note: les opérations sensibles (DELETE, modifications financières, changements de stage deal) sont automatiquement interceptées et nécessitent une confirmation du dirigeant avant exécution.`,
  {
